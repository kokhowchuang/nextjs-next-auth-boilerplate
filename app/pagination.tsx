...
export default function Pagination({
  ...
  const items = Array(totalPages).fill(0);
        ...
        <div>
          ...
          >
            <a
              ...
              className="disabled relative inline-flex items-center rounded-l-md cursor-pointer px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
